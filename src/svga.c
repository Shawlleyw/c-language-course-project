...
void bar3(int x1, int y1, int x2, int y2, int color)
{
  Line1(x1, y1, x2, y1, color);
  Line1(x1, y2, x2, y2, color);
  Line1(x1, y1, x1, y2, color);
  Line1(x2, y1, x2, y2, color);
  Line1(x1 - 1, y1 - 1, x2 + 1, y1 - 1, color);
  Line1(x1 - 1, y2 + 1, x2 + 1, y2 + 1, color);
  Line1(x1 - 1, y1 - 1, x1 - 1, y2 + 1, color);
  Line1(x2 + 1, y1 - 1, x2 + 1, y2 + 1, color);
  Line1(x1 + 1, y1 + 1, x2 - 1, y1 + 1, color);
  Line1(x1 + 1, y2 - 1, x2 - 1, y2 - 1, color);
  Line1(x1 + 1, y1 + 1, x1 + 1, y2 - 1, color);
  Line1(x2 - 1, y1 + 1, x2 - 1, y2 - 1, color);
